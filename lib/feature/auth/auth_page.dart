        ...
        body: Center(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                    color: Colors.black.withOpacity(0.25), blurRadius: 25),
              ],
            ),
            child: Padding(
                  ...
                  Positioned(
                    ...
                    child: SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        style: Jost(16, Colors.black, FontWeight.w300),
                        controller: _login,
                        decoration: InputDecoration(
                          ...
                          focusedBorder: const OutlineInputBorder(
                            borderSide:
                                BorderSide(color: MainColors.mainPurple),
                          ),
                        ),
